                  ...
                  <div className="card-background">
                    <div className="card ">
                      ...
                      <div className="card-info">
                        ...
                        <div className="card-label yellow colorblindable" />
                        <div className="card-label red colorblindable" />
                        <div className="card-label orange colorblindable" />
                        <div className="card-label blue colorblindable" />
                        <div className="card-label purple colorblindable" />
                        <p>
